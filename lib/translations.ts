...
export const translations: Record<Language, TranslationData> = {
  en: {
    ...
    landing: {
      ...
      toolsTitle1: '17 Powerful Tools', toolsTitle2: 'One Platform',
  ...
  tr: {
    ...
    landing: {
      ...
      toolsTitle1: '17 Güçlü Araç', toolsTitle2: 'Tek Platform',
  ...
  ru: {
    ...
    landing: {
      ...
      toolsTitle1: '17 мощных инструментов', toolsTitle2: 'Одна платформа',
  ...
  de: {
    ...
    landing: {
      ...
      toolsTitle1: '17 leistungsstarke Werkzeuge', toolsTitle2: 'Eine Plattform',
