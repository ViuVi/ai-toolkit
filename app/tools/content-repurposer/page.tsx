...
export default function ContentRepurposerPage() {
  ...
  const fillExample = () => { setOriginalContent('I spent 2 years building my personal brand. The biggest lesson? Consistency beats talent. I posted every day for 365 days. Most got under 100 views. Then one went viral with 2M views.') }
