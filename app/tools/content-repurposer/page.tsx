...
const toolTexts: Record<string, Record<string, string>> = {
  tr: { title: 'İçerik Dönüştürücü', originalContent: 'Orijinal İçerik', contentPlaceholder: 'Blog yazısı, video scripti veya herhangi bir içeriği yapıştırın...', contentType: 'İçerik Türü', generate: '5 Platforma Dönüştür', generating: '{t.generating}', emptyTitle: 'İçerik Dönüştürücü', emptyDesc: '{t.emptyDesc}', blog: 'Blog', video: 'Video', podcast: 'Podcast', tweet: 'Tweet' },
