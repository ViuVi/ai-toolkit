...
const toolTexts: Record<string, Record<string, string>> = {
  tr: { title: 'Hook Üretici Pro', topic: 'Konu / Niş', topicPlaceholder: 'örn: Yapay zeka, Fitness, Para kazanma...', platform: 'Platform', tone: 'Ton', generate: '20 Viral Hook Üret', generating: '20 Hook Üretiliyor...', bestHook: 'En İyi Hook', topicInsight: 'Konu Analizi', copy: t.copy, copied: '✓', copyAll: t.copyAll, download: 'TXT İndir', professional: 'Profesyonel', casual: 'Samimi', humorous: 'Esprili', dramatic: 'Dramatik', emptyTitle: '20 Viral Hook', emptyDesc: 'Konunuzu girin, scroll-durduran hook\'lar üretelim' },
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch('/api/hook-generator', {
        ...
        body: JSON.stringify({ topic, platform, tone, language, userId: user.id })
      })
