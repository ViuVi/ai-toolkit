...
export default function ToolPage() {
  ...
  const title = toolNames[language].trendDetector
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch('/api/trend-detector', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ input, userId, language }) })
