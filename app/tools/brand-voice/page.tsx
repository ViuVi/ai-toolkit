...
export default function ToolPage() {
  ...
  const title = toolNames[language].brandVoice
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch('/api/brand-voice', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ input, userId, language }) })
