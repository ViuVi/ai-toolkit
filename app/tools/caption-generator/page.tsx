...
const toolTexts: Record<string, Record<string, string>> = {
  tr: { title: 'Açıklama Üretici', topic: 'Konu', topicPlaceholder: 'örn: Yeni ürün lansmanı, Motivasyon...', platform: 'Platform', tone: 'Ton', generate: '5 Caption Üret', generating: 'Üretiliyor...', copy: t.copy, copyAll: t.copyAll, download: 'TXT İndir', emptyTitle: 'Caption\'lar', emptyDesc: 'Konunuzu girin', professional: 'Profesyonel', casual: 'Samimi', humorous: 'Esprili', inspiring: 'İlham Verici', hashtags: 'Hashtag\'ler' },
