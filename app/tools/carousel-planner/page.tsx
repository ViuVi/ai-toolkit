...
const toolTexts: Record<string, Record<string, string>> = {
  tr: { title: 'Carousel Planner', topic: 'Carousel Konusu', topicPlaceholder: 'örn: 5 adımda viral olmak...', slideCount: 'Slide Sayısı', style: 'Stil', generate: 'Carousel Oluştur', generating: 'Planlanıyor...', copy: 'Kopyala', emptyTitle: 'Carousel Planner', emptyDesc: "Konunuzu girin, slide'ları planlayalım", concept: 'Konsept', caption: 'Caption', design: 'Tasarım', educational: 'Eğitici', storytelling: 'Hikaye', listicle: 'Liste', howTo: 'Nasıl Yapılır' },
