...
export default function ToolPage() {
  ...
  const title = toolNames[language].viralScore
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch('/api/viral-score', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ input, userId, language }) })
