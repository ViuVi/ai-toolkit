...
export default function ToolPage() {
  ...
  const title = toolNames[language].postScheduler
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch('/api/post-scheduler', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ input, userId, language }) })
