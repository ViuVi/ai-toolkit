...
export default function ToolPage() {
  ...
  const title = toolNames[language].contentCalendar
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch('/api/content-calendar', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ input, userId, language }) })
