...
export default function ToolPage() {
  ...
  const title = toolNames[language].qrCode
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch('/api/qr-code-generator', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ input, userId, language }) })
