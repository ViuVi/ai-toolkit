        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="text" value={fullName} onChange={e => setFullName(e.target.value)} required className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/50 transition" placeholder="John Doe" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="password" value={password} onChange={e => setPassword(e.target.value)} required minLength={6} className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/50 transition" placeholder="••••••••" />
          ...
          <p className="text-center text-gray-400 mt-6">
            ...
            <Link href="/login" className="text-purple-400 hover:text-purple-300 ml-2 font-medium">Sign in</Link>
          </p>

          {/* Terms */}
          <p className="text-center text-gray-500 text-xs mt-4">
            By creating an account, you agree to our <Link href="/terms" className="text-gray-400 hover:text-white">Terms</Link> and <Link href="/privacy" className="text-gray-400 hover:text-white">Privacy Policy</Link>
          </p>
        </div>
      </div>
